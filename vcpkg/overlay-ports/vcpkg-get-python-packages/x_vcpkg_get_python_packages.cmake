...
function(x_vcpkg_get_python_packages)
    ...
    if(CMAKE_HOST_WIN32 AND
        ...
        if(NOT EXISTS "${python_dir}/easy_install${VCPKG_HOST_EXECUTABLE_SUFFIX}")
            ...
            # Scripts/pip.exe can exit 1 on Python 3.14+; use "python -m pip" instead.
            vcpkg_execute_required_process(COMMAND "${arg_PYTHON_EXECUTABLE}" -m pip install virtualenv --no-warn-script-location
                                           WORKING_DIRECTORY "${CURRENT_BUILDTREES_DIR}"
