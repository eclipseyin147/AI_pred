...
if(WIN32)
  file(GLOB CUDNN_PROGRAM_FILES_DIRS
    LIST_DIRECTORIES true
    "$ENV{ProgramFiles}/NVIDIA/CUDNN/v[1-9]*.[0-9]*"
    "$ENV{ProgramW6432}/NVIDIA/CUDNN/v[1-9]*.[0-9]*"
  )
  list(APPEND CUDNN_VERSION_DIRS ${CUDNN_PROGRAM_FILES_DIRS})
endif()
...
find_path(CUDNN_INCLUDE_DIR NAMES cudnn.h cudnn_v8.h cudnn_v7.h
  HINTS ${CUDNN_HINT_DIRS}
  PATH_SUFFIXES ${CUDNN_INCLUDE_SUFFIXES})
find_library(CUDNN_LIBRARY NAMES cudnn cudnn8 cudnn7
  HINTS ${CUDNN_HINT_DIRS} /usr/lib/x86_64-linux-gnu/ /usr/lib/aarch64-linux-gnu/ /usr/
  PATH_SUFFIXES ${CUDNN_LIBRARY_SUFFIXES})
...
if(CUDNN_LIBRARY)
  ...
  get_filename_component(CUDNN_LIBRARY_ROOT "${CUDNN_LIBRARY_DIR}" DIRECTORY)
  set(CUDNN_DLL_DIR
    "${CUDNN_LIBRARY_DIR}"
    "${CUDNN_LIBRARY_ROOT}/bin"
    "${CUDNN_LIBRARY_ROOT}/../bin"
  )
  find_file(CUDNN_LIBRARY_DLL NAMES cudnn64_${_CUDNN_VERSION_MAJOR}.dll PATHS ${CUDNN_DLL_DIR} NO_DEFAULT_PATH)
endif()
